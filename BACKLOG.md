...
<!-- refresh-queue:start -->
_Generated by `python3 scripts/refresh_queue.py --write-backlog` on 2026-09-26. Do not edit between the markers: review dates and follow-ups live in `data/refresh_ledger.json`, and units come from the data itself._

**Coverage:** 1 of 132 sites reviewed within 90 days; 0 of 15 companies reviewed within 30 days; 0 of 52 states reviewed within 120 days.
...
1. `site:aws-loudoun-va` (AWS US-East-1 (Northern Virginia) (Ashburn, VA; operational)): never reviewed; record curated 2026-05-14 (1.5x target)
2. `state:GA` (Georgia): never reviewed; 31 records
3. `site:aws-new-carlisle-in` (Project Rainier (New Carlisle) (New Carlisle, IN; operational)): never reviewed; record curated 2026-05-14 (1.5x target)
4. `company:coreweave` (CoreWeave (4 tracked sites)): never reviewed; record curated 2026-05-15 (4.5x target)
...
| `site:meta-newton-ga` | Newton County Data Center (Stanton Springs) (Social Circle, GA; operational) | never reviewed; record curated 2026-05-14 (1.5x target) |
| `site:meta-prineville-or` | Prineville Data Center (Prineville, OR; operational) | never reviewed; record curated 2026-05-14 (1.5x target) |
...
| Unit | What | Why now |
|---|---|---|
| `company:crusoe` | Crusoe (6 tracked sites) | never reviewed; record curated 2026-05-15 (4.5x target) |
...
| `company:meta` | Meta (14 tracked sites) | never reviewed; record curated 2026-05-16 (4.4x target) |
...
| 2026-10-02 | `state:CA` | San Francisco: Sup. Walton's 45-day interim zoning moratorium (introduced Sept 14/15) — approved? |
...
| 2026-10-03 | `state:CA` | moratorium `indio-ca-2026-06` (Indio) reaches its computed end date 2026-10-03: lapsed, extended, or replaced by a permanent rule? |
...
- Statesville: a 180-day moratorium was reportedly enacted Sept 15 (it
  surfaced during the Charlotte re-check). Verify it and add a record.
