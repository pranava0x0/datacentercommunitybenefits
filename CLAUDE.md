...
Hyperscaler-adjacent colocation operators not yet tracked (Equinix, Digital Realty) remain **out of scope** unless they meet the same two-gate test. The QTS addition is the precedent for evaluating future operators; the SB Energy/Amentum/Brookfield addition is the precedent for evaluating a DOE-adjacent or multi-party one.
